  ...
  return (
    <aside
      className="
        ...
        border border-base-300/85
        rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.42)]
        py-2 px-3
    ...
    >
      ...
      <nav className="flex flex-row md:flex-col items-center justify-around gap-1 md:gap-4 w-full md:w-auto overflow-x-auto scrollbar-none">
          ...
          return (
            ...
            >
              ...
              <div
                ...
                `}
              >
                <Icon size={16} strokeWidth={active ? 2.5 : 2} className="md:w-[22px] md:h-[22px]" />
              </div>
