...
const ManagementSidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <aside className="max-h-screen w-10 flex flex-col bg-base-100 border border-base-300 shrink-0 justify-center top-50 md:top-30 rounded-l-2xl fixed right-0 z-100">
